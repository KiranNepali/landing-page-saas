      ...
      <div className="container">
        <div className="section-heading">
          ...
          <p className="section-description mt-5">
            ...
            dicta aperiam distinctio voluptatem repellendus enim quia in
            cupiditate labo
          </p>
        </div>
        <div className="flex-col flex gap-6 items-center mt-10 lg:flex-row lg:items-end lg:justify-center">
          {pricingTiers.map(
            ({
              title,
              monthlyPrice,
              ...
              >
                ...
                <div className="flex items-baseline gap-1 mt-[30px]">
                  <span className="text-4xl font-bold tracking-tighterl leading-none">
                    ${monthlyPrice}
                  </span>
                ...
                <ul className="flex-col gap-5 flex mt-8">
