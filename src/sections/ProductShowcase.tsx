...
export const ProductShowcase = () => {
  return (
    <section className="bg-gradient-to-b from-[#FFFFFF] to to-[#D2DCFF] py-[24] overflow-x-clip">
      <div className="container">
       <div className="section-heading">
        ...
        <p className="section-description mt-5">
          ...
          laboriosam dolorem necessitatibus perspiciatis fuga repellendus
          recusandae reprehenderit dolore facilis incidunt.
        </p>
       </div>
